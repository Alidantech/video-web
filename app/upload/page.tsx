                    ...
                    <div className="mt-8 md:flex gap-6">
                        ...
                        {!fileDisplay ? 
                            ...
                            >
                                ...
                                <label 
                                    htmlFor="fileInput" 
                                    className="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-pink-500 rounded-sm cursor-pointer"
                                >
                                    Select file
                                </label>
                                <input 
                        ...
                        :
                            ...
                            >
                                ...
                                <img 
                                    ...
                                    width="90" 
                                    src="/images/BeautyTechies-logo-white.png"
                                />
                                <video 
                                    autoPlay
                                    loop
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-[#F8F8F8] py-4 px-6">
                                ...
                                <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                                    <button className="px-8 py-1.5 text-white text-[15px] bg-pink-500 rounded-sm">
                                        Edit
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button 
                                    ...
                                    className="px-10 py-2.5 mt-8 border text-[16px] text-white bg-pink-500 rounded-sm"
                                >
