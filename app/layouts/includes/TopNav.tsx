...
export default function TopNav() {
  ...
  return (
    <>
      <div
        id="TopNav"
        className="fixed bg-white z-30 flex items-center w-full border-b h-[54px]"
      >
        <div
        ...
        >
          <Link href="/">
            <div className="h-8 w-auto font-bold text-lg">
              <span className="text-pink-500">Beauty</span>Techies
            </div>{" "}
          </Link>
          ...
          <div className="flex items-center gap-3 ">
            {/* <button
              onClick={() => goTo()}
              className="flex items-center border rounded-full px-2 py-[6px] hover:bg-gray-100 pl-1.5"
            >
            ...
            {!userContext?.user?.id ? (
              <div className="flex items-center">
                {/* <button
                  ...
                  className="flex items-center bg-pink-500 text-white border rounded-full px-3 py-[6px]"
                >
            ...
            <div className="relative hidden md:flex items-center border border-2 border-[#F9731630] justify-end bg-[#F9731605] p-0 rounded-full max-w-[430px] w-full">
              <input
                type="text"
